...
void style_init(void)
{
    ...
    if (!stylebuf)
        stylebuf = new fltk::TextBuffer(textbuf->length());
...
void find2_cb(fltk::Widget *w, void *v)
{
    ...
    if (found)
    {
        ...
        fltk::alert("No occurrences of \'%s\' found!", e->search);
}

void set_title(fltk::Window *w)
{
    if (filename[0] == '\0')
        strcpy(title, "Untitled.txt");
    else
    {
        char *slash;
...
void replace2_cb(fltk::Widget *, void *v)
{
    ...
    if (found)
    {
        ...
        fltk::alert("No occurrences of \'%s\' found!", find);
}
...
void replall_cb(fltk::Widget *, void *v)
{
    ...
    if (times)
        fltk::message("Replaced %d occurrences.", times);
    else
        fltk::alert("No occurrences of \'%s\' found!", find);
}
